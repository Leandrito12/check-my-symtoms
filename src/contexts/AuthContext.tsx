...
/**
 * Toda la lógica de auth: UN solo getSession() + UNA sola suscripción onAuthStateChange.
 * Se ejecuta una única vez dentro de <AuthProvider>. Antes esto vivía en useAuth() y se
 * repetía por cada pantalla, lo que producía contención del lock de gotrue (timeouts 10s).
 */
...
export type AuthContextValue = ReturnType<typeof useProvideAuth>;
...
export function useAuthContext(): AuthContextValue {
  ...
  if (!ctx) {
    throw new Error('useAuth debe usarse dentro de <AuthProvider> (ver app/_layout.tsx).');
  }
  return ctx;
}
